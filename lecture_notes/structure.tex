...
\newcounter{mydef}
\stepcounter{mydef}
\newenvironment{mydefinition}{\begin{block}{Definition \themydef\stepcounter{mydef}}}{\end{block}}
...
\newcommand{\exercisen}{\theexercise\stepcounter{exercise}}
\newcommand{\examplen}{\theexample\stepcounter{example}}
